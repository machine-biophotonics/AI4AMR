#!/usr/bin/env python3
"""
Generate aggregate confusion matrices for plate_fold_no_aug.
Same logic as plate_fold/generate_combined_confusion.py
"""
...
def main():
    ...
    for fold in folds:
        ...
        if not os.path.exists(csv_path):
            print(f"Skipping {fold}: no predictions_all_crops.csv")
            continue
