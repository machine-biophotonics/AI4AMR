...
def train_single_fold(test_plate):
    ...
    val_dataset = MultiCropDataset(val_paths, val_labels, plate_data, augment=False, seed=SEED)
    test_dataset = MultiCropDataset(test_paths, test_labels, plate_data, augment=False, seed=SEED)
